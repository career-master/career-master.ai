...
const { createQuizSetSchema, updateQuizSetSchema, quizSetIdParamSchema, topicIdParamSchema, quizIdParamSchema, validate } = require('./quiz-sets.validation');
...
// Admin: Get quiz sets by quiz ID (for edit form: which topic this quiz is linked to)
router.get('/quiz/:quizId', adminMiddleware, validate(quizIdParamSchema), QuizSetController.getQuizSetsByQuizId);
